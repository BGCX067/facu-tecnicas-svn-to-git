' Clase Genérica para Impresión Personalizada
' Herney Eduardo Duque A.
' Noviembre 2003

' Dimesiones de las Páginas
' Carta Vertical    : 660
' Carta Horizontal  : 900
' Oficio Vertical   : 1200
...
Public Class Impresion
    ...
    Public Sub GenerarReporte(Optional ByVal LandScape As Boolean = False, Optional ByVal Tipo As String = "Carta")
        ...
        Dim psActivo As PaperSize = Nothing
